...
// // API functions (replace with your actual API service if you have one)
...
//             // 'Content-Type' will be set by axios for FormData
//         }
//     };
// };
...
//     const [sectionFiles, setSectionFiles] = useState([]); // To manage file objects for sections
...
//     // Generic handler for array fields (fares, faqs, sections)
...
//         // Important: Remove file data from sections before stringifying
...
//                         <h3 className="font-semibold">Fares</h3>
//                         {formData.fares.map((fare, index) => (
//                             <div key={index} className="flex items-center gap-2">
//                                 <input value={fare.vehicleType} onChange={(e) => handleArrayChange(index, 'vehicleType', e.target.value, 'fares')} placeholder="Vehicle Type" className="p-2 border rounded w-full" />
//                                 <input type="number" value={fare.price} onChange={(e) => handleArrayChange(index, 'price', e.target.value, 'fares')} placeholder="Price" className="p-2 border rounded w-full" />
//                                 <button type="button" onClick={() => removeArrayItem(index, 'fares')} className="p-2 bg-red-500 text-white rounded"><Trash2 size={16} /></button>
//                             </div>
//                         ))}
//                         <button type="button" onClick={() => addArrayItem('fares', { vehicleType: '', price: '' })} className="mt-2 text-sm px-3 py-1 bg-blue-500 text-white rounded">Add Fare</button>
//                     </div>
...
//                             <div key={index} className="space-y-1 p-2 border-b">
...
//                                 <button type="button" onClick={() => removeArrayItem(index, 'faqs')} className="text-xs p-1 bg-red-100 text-red-600 rounded">Remove FAQ</button>
//                             </div>
//                         ))}
//                         <button type="button" onClick={() => addArrayItem('faqs', { question: '', answer: '' })} className="mt-2 text-sm px-3 py-1 bg-blue-500 text-white rounded">Add FAQ</button>
//                     </div>
...
//                                 <input value={section.heading} onChange={(e) => handleArrayChange(index, 'heading', e.target.value, 'sections')} placeholder="Heading" className="p-2 border rounded col-span-2" />
//                                 <select value={section.headingType} onChange={(e) => handleArrayChange(index, 'headingType', e.target.value, 'sections')} className="p-2 border rounded">
//                                     {['h2', 'h3', 'h4', 'h5', 'h6', 'p'].map(h => <option key={h} value={h}>{h.toUpperCase()}</option>)}
//                                 </select>
//                                 <input type="number" value={section.order} onChange={(e) => handleArrayChange(index, 'order', e.target.value, 'sections')} placeholder="Order" className="p-2 border rounded" />
//                                 <textarea value={section.paragraph} onChange={(e) => handleArrayChange(index, 'paragraph', e.target.value, 'sections')} placeholder="Paragraph" className="p-2 border rounded col-span-2" rows="4"></textarea>
//                                 <div>
//                                     <label className="text-sm block">Section Image</label>
//                                     <input type="file" onChange={(e) => handleFileChange(index, e.target.files[0])} className="p-2 border rounded w-full text-sm" />
//                                     {routeToEdit && section.image && !sectionFiles[index] && <img src={section.image} alt="Current" className="h-16 mt-2 rounded" />}
//                                 </div>
...
//                                 <button type="button" onClick={() => removeArrayItem(index, 'sections')} className="col-span-2 p-2 bg-red-500 text-white rounded w-full">Remove Section</button>
//                             </div>
//                         ))}
//                         <button type="button" onClick={() => addArrayItem('sections', { heading: '', headingType: 'h2', paragraph: '', order: 0, imageAltText: '' })} className="mt-2 text-sm px-3 py-1 bg-blue-500 text-white rounded">Add Section</button>
//                     </div>
