...
const ManagePages = () => {
  ...
  const handleEdit = (page) => {
    ...
    setFormData({
      ...
      bannerTitle: page.bannerTitle || '',
      bannerAltText: page.bannerAltText || '',
      bannerAlign: page.bannerAlign || 'center',
    });
    setBannerFile(null);
    setSectionFiles({});
    window.scrollTo(0, 0);
    ...
    <div className="p-6 bg-slate-50 min-h-full">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md mb-8 space-y-6">
        ...
        <fieldset className="border p-4 rounded-md">
          ...
          <input name="bannerTitle" placeholder="Banner Title" value={formData.bannerTitle} onChange={handleInputChange} className="p-2 border rounded-md w-full mt-2" />
          <input name="bannerAltText" placeholder="Banner Alt Text" value={formData.bannerAltText} onChange={handleInputChange} className="p-2 border rounded-md w-full mt-2" />
          <label className="text-sm font-medium mt-2 block">Banner Align</label>
          <select name="bannerAlign" value={formData.bannerAlign} onChange={handleInputChange} className="mt-1 w-full p-3 border rounded-md bg-white">
