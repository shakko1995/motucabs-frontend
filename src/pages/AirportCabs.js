...
//   return (
//     <div
//       className={`relative bg-white rounded-xl shadow-lg p-5 flex flex-col sm:flex-row items-center gap-5 border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
//         isRecommended ? "border-blue-500" : "border-transparent"
//       }`}
//     >
//       {isRecommended && (
...
//             <Car size={16} className="mr-1.5 text-blue-500" />
//             {packageDetails.vehicleType}
//           </span>
//           <span className="flex items-center text-slate-700">
//             <Users size={16} className="mr-1.5 text-blue-500" />
//             {packageDetails.seater} Seater
//           </span>
//           {packageDetails.ac && (
//             <span className="flex items-center text-slate-700">
...
//             <Gauge size={14} className="mr-2 text-gray-400" /> Extra Fare: ₹{packageDetails.extraKmCharge}/km
//           </p>
//           <p className="flex items-center">
//             <Clock size={14} className="mr-2 text-gray-400" /> Waiting Charge: ₹{packageDetails.waitingTimeCharge}/hr
//           </p>
//           <p className="flex items-center">
//             <Moon size={14} className="mr-2 text-gray-400" /> Night Charge: ₹{packageDetails.nightDrivingCharge}
//           </p>
//         </div>
//       </div>
//       <div className="w-full sm:w-1/4 text-center sm:text-right border-t sm:border-t-0 sm:border-l-2 border-dashed pl-0 sm:pl-5 pt-4 sm:pt-0">
...
//         <button
//           onClick={onSelect}
//           className="w-full sm:w-auto bg-orange-500 text-white font-bold py-3 px-8 rounded-lg shadow-md hover:bg-orange-600 transition-all duration-300 transform hover:scale-105"
//         >
//           SELECT
//         </button>
//       </div>
...
//             sortBy === "price_asc" ? "bg-blue-600 text-white shadow" : "text-slate-700 hover:bg-slate-100"
//           }`}
//         >
...
//           className={`flex items-center text-left text-sm p-3 rounded-lg font-medium transition-colors ${
//             sortBy === "price_desc" ? "bg-blue-600 text-white shadow" : "text-slate-700 hover:bg-slate-100"
//           }`}
//         >
...
//       <h4 className="font-semibold text-slate-600 mb-2 text-sm">CAR TYPE</h4>
//       <div className="flex flex-col space-y-1">
//         {["all", "Mini", "Sedan", "SUV"].map((type) => (
//           <button
//             key={type}
//             onClick={() => handleFilterChange("vehicleType", type)}
//             className={`text-left text-sm p-3 rounded-lg font-medium transition-colors ${
//               filters.vehicleType === type ? "bg-blue-600 text-white shadow" : "text-slate-700 hover:bg-slate-100"
//             }`}
//           >
//             {type === "all" ? "All" : type}
//           </button>
...
//     }
//     packages.sort((a, b) =>
//       sortBy === "price_asc" ? a.packageCost - b.packageCost : b.packageCost - a.packageCost
//     );
//     if (packages.length > 0) packages[0].isRecommended = true;
//     return packages;
//   }, [allPackages, sortBy, filters]);

//   const handleFilterChange = (type, value) => setFilters((prev) => ({ ...prev, [type]: value }));

//   const handleSelectCab = (selectedPackage) => {
//     const tripDetails = { from, to, tripType: "Airport Ride", pickupDate: date, pickupTime: time };
//     navigate("/review-booking", { state: { packageDetails: selectedPackage, tripDetails } });
//   };
...
//       <div className="max-w-7xl mx-auto p-4 sm:p-6">
//         {isFilterOpen && (
//           <div onClick={() => setIsFilterOpen(false)} className="fixed inset-0 bg-black/40 z-40 lg:hidden"></div>
//         )}
//         <div
