...
// import { Star, ArrowLeft, Car, Snowflake, Users, ShieldCheck, TrendingUp, TrendingDown } from 'lucide-react';


// const vehicleData = {
//   Mini: { name: "Indica, Swift", image: "https://jsak.mmtcdn.com/cabs_cdn_dt/image/LighterFunnel_Cabs/Hatchback_2x.png" ,alt: "Mini Car", fuel: "CNG/Diesel" },
//   Sedan: { name: "Dzire, Etios", image: "https://jsak.mmtcdn.com/cabs_cdn_dt/image/LighterFunnel_Cabs/Hatchback_2x.png", alt: "Sedan Car", fuel: "CNG/Diesel" },
//   SUV: { name: "Ertiga, Xylo", image: "https://jsak.mmtcdn.com/cabs_cdn_dt/image/LighterFunnel_Cabs/Hatchback_2x.png", alt: "SUV Car", fuel: "CNG/Diesel" }
// };
...
// // Cab Card Component
// // ===================================================================
// const CabCard = ({ packageDetails, isRecommended }) => {
...
//         <p className="text-xs text-black font-medium mb-3">Advance: ₹{packageDetails.advanceAmount}</p>
//         <button className="w-full sm:w-auto bg-orange-500 text-white font-bold py-3 px-8 rounded-lg shadow-md hover:bg-orange-600 transition-all duration-300 transform hover:scale-105">
//           SELECT
//         </button>
//       </div>
//     </div>
...
//     if (filters.vehicleType !== 'all') packages = packages.filter(pkg => pkg.vehicleType === filters.vehicleType);
//     if (filters.ac === 'ac_only') packages = packages.filter(pkg => pkg.ac);
...
//         <div className="mb-6">
//             <button onClick={() => navigate(-1)} className="flex items-center text-sm text-blue-600 hover:text-blue-800 font-semibold transition-colors">
...
//             <div className="bg-white p-5 rounded-xl shadow-lg sticky top-6">
//                <h3 className="font-bold text-xl text-slate-800 border-b-2 border-slate-100 pb-3">Filter & Sort</h3>
...
//                   <div className="flex flex-col space-y-1">
//                      <button onClick={() => handleFilterChange('vehicleType', 'all')} className={`text-left text-sm p-3 rounded-lg font-medium transition-colors ${filters.vehicleType === 'all' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 hover:bg-slate-100'}`}>All Types</button>
...
//                 {displayedPackages.map(pkg => (<CabCard key={pkg._id} packageDetails={pkg} isRecommended={pkg.isRecommended} />))}
//               </div>
//             ) : (
...
import { useSearchParams, useNavigate } from 'react-router-dom';
import axios from 'axios';
import { Star, ArrowLeft, Car, Snowflake, Users, ShieldCheck, TrendingUp, TrendingDown, Filter, X } from 'lucide-react';
...
const vehicleData = {
  ...
  SUV: { name: "Ertiga, Xylo", image: "https://jsak.mmtcdn.com/cabs_cdn_dt/image/LighterFunnel_Cabs/Hatchback_2x.png" }
};
    ...
    <div className="bg-slate-100 min-h-screen">
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-6 flex justify-between items-center">
            ...
            <button onClick={() => setIsFilterOpen(true)} className="lg:hidden flex items-center gap-2 px-4 py-2 bg-white border rounded-lg shadow font-semibold">
